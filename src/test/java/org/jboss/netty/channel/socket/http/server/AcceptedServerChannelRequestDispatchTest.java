...
import org.jboss.netty.channel.socket.http.server.HttpTunnelAcceptedChannelRequestDispatch;
import org.jboss.netty.channel.socket.http.server.ServerMessageSwitchUpstreamInterface;
...
public class AcceptedServerChannelRequestDispatchTest {
    ...
    private HttpTunnelAcceptedChannelRequestDispatch handler;
    ...
    public void setUp() throws Exception {
        ...
        handler = new HttpTunnelAcceptedChannelRequestDispatch(messageSwitch);
        pipeline.addLast(HttpTunnelAcceptedChannelRequestDispatch.NAME, handler);
