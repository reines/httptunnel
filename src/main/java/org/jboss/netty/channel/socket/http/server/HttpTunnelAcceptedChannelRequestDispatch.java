 ...
 * @author OneDrum Ltd.
 */
class HttpTunnelAcceptedChannelRequestDispatch extends SimpleChannelUpstreamHandler {

    public static final String NAME = "AcceptedServerChannelRequestDispatch";

    private static final InternalLogger LOG = InternalLoggerFactory
            .getInstance(HttpTunnelAcceptedChannelRequestDispatch.class);

    private final ServerMessageSwitchUpstreamInterface messageSwitch;

    public HttpTunnelAcceptedChannelRequestDispatch(
